    ...
    <>
        ...
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <ul className="hidden lg:flex col-start-4 col-end-8 text-white  items-center">
            <LinkScroll
              ...
              className={
                ...
                (activeLink === "about"
                  ? " text-[#FE9A00] animation-active "
                  : " text-white hover:text-[#FE9A00] a")
              }
            >
              About
            </LinkScroll>
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
            <a href="mailto:jogeshwariindustries77@gmail.com">
              <ButtonOutline className="text-white">Contact Us</ButtonOutline>
            </a>
          </div>
        </nav>
      </header>
      ...
      <nav className="fixed lg:hidden bottom-0 left-0 right-0 z-20 px-4 sm:px-8 shadow-t ">
        <div className="bg-black sm:px-3">
          <ul className="flex w-full justify-between cursor-pointer items-center text-white">
            <LinkScroll
              activeClass="active"
              to="about"
              spy={true}
